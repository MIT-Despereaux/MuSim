...
(bin_centers, counts, errs, expected) = DistributionTest.test_zenangle_dist(_randcos3, expected_f, π / 2, π)
...
(pos, single_hits, single_hits_err, predicted_hits) = CoverageTest.test_planar_coincidence()
